...
Route::get('/saved-ads', 'AdController@savedAds')->name('saved-ads')->middleware('auth', 'verified', 'CheckBanned');
Route::get('/get-saved-ads', 'AdController@getSavedAds')->name('get-saved-ads')->middleware('auth', 'verified', 'CheckBanned');
...
Route::post('postAd/favorite', 'UserController@postAdFavorite');
