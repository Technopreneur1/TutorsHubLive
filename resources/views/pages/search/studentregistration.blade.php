...
@section('content')
    ...
    <div class="body_wrap">
        ...
        <div class="page_wrap">
            ...
            <header style="margin-bottom: 4rem;" class="top_panel top_panel_default without_bg_image with_featured_image header-dark scheme_default">    <div class="top_panel_top">
