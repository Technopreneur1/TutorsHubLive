...
<script type="text/javascript">
    window._wpemojiSettings = {"baseUrl":"https:\/\/s.w.org\/images\/core\/emoji\/12.0.0-1\/72x72\/","ext":".png","svgUrl":"https:\/\/s.w.org\/images\/core\/emoji\/12.0.0-1\/svg\/","svgExt":".svg","source":{"concatemoji":"https:\/\/smarthead.ancorathemes.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=5.4"}};
...
<link rel='stylesheet' id='wpml-legacy-vertical-list-0-css'  href='{{url('wp-content/plugins/sitepress-multilingual-cms/templates/language-switchers/legacy-list-vertical/style.css')}}' type='text/css' media='all' />
...
<link rel='stylesheet' id='js_composer_front-css'  href='{{url('wp-content/plugins/js_composer/assets/css/js_composer.min.css')}}' type='text/css' media='all' />
<link rel='stylesheet' id='wpgdprc.css-css'  href='{{url('wp-content/plugins/wp-gdpr-compliance/assets/css/front.css')}}' type='text/css' media='all' />
      ...
      function initAutocomplete() {
        ...
        searchBox.addListener("places_changed", function() {
          var places = searchBox.getPlaces();
             ...
             document.getElementById("lat").value =  JSON.stringify(places[0].geometry.location.lat());
            document.getElementById("lng").value =  JSON.stringify(places[0].geometry.location.lng());
;
          if (places.length == 0) {
            return;
